...
public class BluetoothSerialService {
   ...
   */
  public BluetoothSerialService(Handler handler, Activity mactivity) {
...
//        }
  ...
  public synchronized void connected(BluetoothSocket socket, BluetoothDevice device, final String socketType) {
    ...
    if (ActivityCompat.checkSelfPermission(activity, Manifest.permission.BLUETOOTH_CONNECT) != PackageManager.PERMISSION_GRANTED) {
      ...
      ActivityCompat.requestPermissions(activity, new String[]{Manifest.permission.BLUETOOTH_CONNECT}, 255);
      return;
    }
  ...
  private class ConnectThread extends Thread {
    ...
    public void run() {
      ...
      if (ActivityCompat.checkSelfPermission(activity, Manifest.permission.BLUETOOTH_SCAN) != PackageManager.PERMISSION_GRANTED) {
        ...
        ActivityCompat.requestPermissions(activity, new String[]{Manifest.permission.BLUETOOTH_SCAN}, 255);
        return ;
      }
